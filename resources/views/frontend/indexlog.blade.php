				...
				<div class="header-menu-extra">
					...
					<ul class="list-inline">
						 @auth
                               ...
                               <li><a href="{{ url('/cart/'.  Auth::user()->id ) }}" style="font-size:20px">&nbsp&nbsp&nbsp&nbsp&nbsp<i class="ti-shopping-cart"></i> 	</a>   <span style="margin-top: -10px;position: absolute;color: darkgray;padding-left: 8px;">{{ $count[0]->count }}</span></li>
